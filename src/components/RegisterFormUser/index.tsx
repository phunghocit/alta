...
const DEFAULT_USER = {fullname:"",phone:"", email:"", role:"", username:"", password:"", confirm_password:"", status:""}
const RegisterFormUser = () => {
  ...
  return (
        ...
        ({ getFieldValue }) => ({
          validator(_, value) {
            ...
            return Promise.reject(
              new Error("Vui lòng kiểm tra lại!")
            );
          },
        }),
      ]}
    ...
    <Row>
        <CancelButton type="primary" onClick={HandleCancel}>Huỷ bỏ</CancelButton>
        <SubmitButton type="primary" onClick={HandleSignUp}>Thêm </SubmitButton>
    </Row>
